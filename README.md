...
timestamps. API bearer tokens are accepted only under `/api/v1/`; they do not
grant access to Switchboard settings or other browser APIs. Provider callback
URLs must remain configured for delivery state to progress after submission.
