...
SETTING_DEFS: tuple[SettingDef, ...] = (
    ...
    SettingDef(
        "behavior.enter_to_send_desktop",
        "Enter sends on desktop",
        "Behavior",
        "bool",
        "1",
        help="Send a message with Enter on desktop devices. Shift+Enter still adds a new line.",
    ),
    SettingDef(
        "behavior.enter_to_send_mobile",
        "Enter sends on mobile",
        "Behavior",
        "bool",
        "0",
        help="Send a message with Enter on phones and other mobile devices. Leave off to use Enter for a new line.",
    ),
    SettingDef(
